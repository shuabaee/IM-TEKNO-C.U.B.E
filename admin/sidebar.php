...
<aside class="sidebar">
    ...
    <nav class="side-links">
        ...
        <a class="<?= $active === 'users' ? 'active' : '' ?>" href="<?= url('admin/users/index.php') ?>">User CRUD</a>
        <a class="<?= $active === 'departments' ? 'active' : '' ?>" href="<?= url('admin/departments/index.php') ?>">Department CRUD</a>
        <a class="<?= $active === 'inventory' ? 'active' : '' ?>" href="<?= url('admin/inventory/index.php') ?>">Inventory CRUD</a>
